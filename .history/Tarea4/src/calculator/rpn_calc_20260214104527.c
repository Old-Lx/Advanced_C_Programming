...
int *parse_int(char *selected_char, s_mem_stack_list *stack_calc) {
    ...
    return; // No es necesario retornar, sólo que la función está definida así en el .h me da flojera modificarlo, además de que aumenta mi tasa de errores
}
